...
{
$res1="This RegNo is allready present";
}
 else
 {
$sql="Insert into StudentTab values('$t1','$p1','$t2','$t3','$t6','$t7','$t8')";
//echo($sql);
$result = $conn->query($sql);
if(!$result)
{
...
<tr><td height ="100" width="25%"></td><td>
    ...
    <form method="POST" name="form1"   action="AdminStudent.php">
    ...
    <tr> <td height="40"> eMail Id </td> <td> <input type="text" name="text7" value=""></td> </tr>
       <tr><td height="60" >  Course Name </td><td>
 <select name="text8" style="height: 25px; width: 250px">
<?php

$sql = "SELECT courseName FROM courseTab order by courseName";
$result = $conn->query($sql);
