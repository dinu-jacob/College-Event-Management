...
<A href="studentmain.php"> Student Main </A> <BR> 
...
print "<tr><td ><a href=studentapply2.php?ecode=" . $row[0] . ">Apply for this event</a></td><td>" . $row[0] . "</td><td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td>" . $row[4] . "</td><td>" . $row[5] . "</td><td>" . $row[6] . "</td></tr>" ;
}
